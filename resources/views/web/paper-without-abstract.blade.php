        ...
        <div class="container custom-container-background z-index-1 py-5">
            <div class="row position-relative z-index-1 pt-5-5">
                <div class="col text-center">
                    <h2 class="text-color-dark font-weight-medium text-8 mb-5-5">Submit Paper Without Abstract ID</h2>
                    <form class="" action="{{ route('paper.wa.submit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
