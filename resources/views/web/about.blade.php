...
<div role="main" class="main">
    <section class="section bg-transparent position-relative border-0 m-0 p-0 mt-5">
        <div class="container custom-container-background z-index-1 py-5">
            ...
            <div class="row position-relative z-index-1 pt-5-5">
                <div class="col text-center">
                    <h2 class="text-color-dark font-weight-medium text-8 mb-5-5">ABOUT ICCESP 2024 ORGANISERS</h2>
                </div>
            </div>
            <div class="row align-items-center pb-5 pb-lg-0 mb-5 mb-lg-0">
                <div class="col-lg-5 text-center text-lg-start appear-animation animated fadeInRightShorterPlus appear-animation-visible" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100" style="animation-delay: 100ms;">
                    <img src="https://www.marian.ac.in/public/frontend/assets/images/logo_dark_new.png" class="img-fluid mb-4 mb-lg-0" alt="">
                </div>
                <div class="col-lg-6 text-center text-lg-start appear-animation animated fadeInRightShorterPlus appear-animation-visible" data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="100" style="animation-delay: 100ms;">
                    <h2 class="text-color-dark font-weight-medium text-8 mb-4-5">MARIAN ENGINEERING COLLEGE</h2>
                    <p class="text-3-5 line-height-8 mb-4 text-justify">Marian Engineering College, located in Kazhakuttom, Trivandrum, stands as a testament to the commitment of the Trivandrum Social Service Society under the Trivandrum Latin Catholic Archdiocese to impart superior technical education. Rooted in a rich legacy of managing high-quality educational institutions for over half a century, the institution aspires to establish itself as a premier center of learning, aligning with international standards and fostering a vibrant research and academic environment in the private sector.<br />
                        With the approval of the All-India Council for Technical Education (AICTE), Government of India, New Delhi, Marian Engineering College exemplifies a dedication to professional excellence. The long-term vision encompasses the creation of a high-level educational institution that not only imparts knowledge but also instills strong ethical values for the betterment of society.
                    </p>
                    <a href="https://www.marian.ac.in/" target="_blank" class="btn btn-secondary btn-outline btn-rounded font-weight-bold btn-px-5 py-3">KNOW MORE</a>
                </div>
            </div>
            ...
            <div class="row align-items-center pt-1 my-5">
                <div class="col-lg-6 text-center text-lg-start order-2 order-lg-1 appear-animation animated fadeInLeftShorterPlus appear-animation-visible" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="100" style="animation-delay: 100ms;">
                    ...
                    <p class="text-3-5 line-height-8 mb-4 text-justify">Habilete Learning Solutions India Pvt. Ltd. is established in 2018 by six professionals each having over 20 years of national and international experience in different industries ranging from education, engineering, communication and information technology. The company is established with the key vision of educating professionals to be leaders in a modern community by acting as a creative agent for change and diversity. To cater to the needs of the current engineering market Habilete serves as a vibrant, innovative and creative hub of learning that never surrenders to conventions. Habilete delivers flexible education and training options, specialized in skill development that will help engineering students and organizations to maximize productivity and to achieve significant competitive advantage. Habilete is also specialized in organizing conference, webinars and seminars to cater to the student community.</p>
