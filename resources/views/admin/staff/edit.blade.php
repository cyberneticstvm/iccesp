        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="{{ route('staff.update', $user->id) }}">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label for="name">Satff Name</label>
                                <input type="text" class="form-control form-control-lg" id="name" name="name" placeholder="Staff Name" value="{{ $user->name }}">
                                @error('name')
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="email" class="form-control form-control-lg" id="email" name="email" placeholder="Email ID" value="{{ $user->email }}">
                                @error('email')
